...
gt_out  = 'ground truth original jpl cloud with air ' + str(grid_size) + ' grid points ' + str(n_sensors) + ' sensors all above the '
...
out_name += 'org jpl cloud with air ' + str(grid_size) + ' grid points ' + str(n_unknowns) + ' unknowns ' + str(n_sensors) + ' sensors all '
...
load_path = "/home/tamarl/MitsubaGradient/Gradient wrapper/jpl/" ##!
