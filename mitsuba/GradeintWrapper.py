        ...
        for bb in range(len(beta0_diff)):
            ...
            for iteration in range(max_iterations):
                ...
                for ss in range(n_sensors):
                    ...
                    [ algo_radiance[ss][nps][bb_gt][bb][iteration], 
...
for bb_gt in range(len(beta_gt_factor)):
    ...
    for bb in range(len(beta0_diff)):
        ...
        out_name = sensors_s + 'dependent grad and fwd Np '+ str(Np_vector[0]) + ' adam unknown 1 beta gt ' + str(beta_gt_factor[bb_gt]) + ' beta0 ' + str(beta0_factor[bb]) + alpha_s +'.png'
